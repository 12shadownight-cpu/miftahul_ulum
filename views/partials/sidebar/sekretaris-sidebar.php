...
<div class="sidebar">
  ...
  <nav class="nav flex-column mt-3">
    <a href="../../pengurus/sekretaris/dashboard.php" class="nav-link"><i class="bi bi-speedometer2"></i>Dashboard</a>
    <!-- Expandable Dropdown -->
    ...
    <div class="collapse" id="bioLayouts">
      <a href="../../pengurus/sekretaris/data-murid.php" class="nav-link"><i class="bi bi-person"></i>Biodata Siswa</a>
      <a href="../../pengurus/sekretaris/data-orangtua.php" class="nav-link"><i class="bi bi-person"></i>Biodata Orangtua</a>
    </div>
    <!-- Expandable Dropdown -->
    ...
    <div class="collapse" id="checkLayouts">
      <a href="../../pengurus/sekretaris/tabel-validasi.php" class="nav-link"><i class="bi bi-table"></i>Tabel Verifikasi</a>
