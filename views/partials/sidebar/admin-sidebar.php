...
<div class="sidebar">
  ...
  <nav class="nav flex-column mt-3">
    <a href="../../pengurus/admin/dashboard.php" class="nav-link"><i class="bi bi-speedometer2"></i>Dashboard</a>
    <!-- Expandable Dropdown -->
    ...
    <div class="collapse" id="noticeLayouts">
      <a href="../../pengurus/admin/data-pengumuman.php" class="nav-link"><i class="bi bi-table"></i>Tabel Pengumuman</a>
      <a href="../../pengurus/admin/input-pengumuman.php" class="nav-link"><i class="bi bi-keyboard"></i>Input Pengumuman</a>
    </div>
    <!-- Expandable Dropdown -->
    ...
    <div class="collapse" id="staffLayouts">
      <a href="../../pengurus/admin/data-pengurus.php" class="nav-link"><i class="bi bi-table"></i>Tabel Pengurus</a>
